...
export const platformIconMeta: Record<string, PlatformMeta> = {
  ...
  douyin: {
    ...
    color: '#FFFFFF',
    short: '抖',
    image: '/platform-icons/douyin.png',
  },
...
export function PlatformLogoMark({
  ...
  const meta =
    platformIconMeta[platform] ?? platformIconMeta[platform.toLowerCase()];
  ...
  if (meta?.icon) {
    return <PlatformIcon icon={meta.icon} size={size} />;
  }
...
export function PlatformBadge({
  ...
  return (
    <span
      className={cn(
        'inline-flex shrink-0 items-center justify-center font-semibold shadow-sm',
        sizeClass,
        className
      )}
